...
(async () => {
  ...
  const rolesMap = {
    ...
    COMMUNITY: [
      'CREATE_COMMUNITY', 'UPDATE_COMMUNITY', 'HIRE_TRADER', 'REMOVE_TRADER', 'VIEW_OPERATION', 'INVITE_MEMBER','DELETE_COMMUNITY','CREATE_COMMUNICATION','UPDATE_COMMUNICATION','DELETE_COMMUNICATION','VIEW_COMMUNICATIONS'
    ],
    MODERATOR: [
